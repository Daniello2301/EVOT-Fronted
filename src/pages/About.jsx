    ...
    return (
        <main className="flex-1 pt-1">
            ...
            >
                ...
                <h1 id="about-title" className="relative z-10 text-4xl font-display font-extrabold text-white_primary text-center md:text-5xl">
                    Acerca de Nosotros
                </h1>
            </section>
            ...
            <section className="max-w-3xl mx-auto px-4 py-16 text-center">
                <h2 className="text-2xl font-display font-bold text-blue_primary mb-4">
                    Nuestra Misión
                </h2>
                <p className="text-lg text-slate-700 tracking-wide text-justify leading-relaxed">
            ...
            <section className="bg-gray_primary py-16">
                <div className="max-w-screen-xl mx-auto px-4">
                    <h2 className="text-2xl font-display font-bold text-blue_primary text-center mb-10">
                        Nuestros Valores
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div
                                key={valor.titulo}
                                className="evot-surface-card p-6 text-center"
                            >
                                <h3 className="text-lg font-bold text-blue_primary mb-2">
                                    {valor.titulo}
                                </h3>
                                <p className="text-slate-700 text-sm leading-relaxed">{valor.descripcion}</p>
                            </div>
                        ))}
                    </div>
                </div>
