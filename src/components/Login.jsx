...
function Login() {
  ...
  return (
    <section className="bg-gray_primary h-screen">
      <div className="flex flex-col items-center justify-center backdrop-blur-sm bg-white/30 px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">

            <h1 className="text-center text-xl font-bold leading-tight tracking-tight text-blue_dark md:text-2xl">
              Ingresa a tu cuenta
            </h1>
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <label htmlFor="email" className="block mb-2 text-sm font-medium text-blue_dark">
                  Tu correo
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="password" className="block mb-2 text-sm font-medium text-blue_dark">
                  Contraseña
                </label>
                <input
                  type="password"
