...
function HeadTableDiplomas() {
    ...
    return (
        <>
            <div className="w-full m-auto grid gap-10 md:flex-row space-y-3 md:space-y-0 md:space-x-4 p-4">

                <div className="w-full m-auto md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-center md:items-center justify-center md:space-x-3 flex-shrink-0">
                    <button onClick={() => {
                        setOpenModalCreateDiploma('default');
                    }} type="button" id="createProductModalButton" data-modal-target={"createProductModal"} data-modal-toggle={"createProductModal"} className="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2   focus:outline-none ">
